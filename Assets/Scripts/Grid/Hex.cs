...
public struct Hex {
    ...
    public static Vector2 R_BASIS	{get => new Vector2(2f, 0) * RADIUS;}
    public static Vector2 Q_BASIS	{get => new Vector2(1f, Mathf.Sqrt(3)) * RADIUS;}
    public static Vector2 Q_INV		{get => new Vector2(1f / 2, - Mathf.Sqrt(3) / 6);}
    public static Vector2 R_INV		{get => new Vector2(0, Mathf.Sqrt(3) / 3);}
